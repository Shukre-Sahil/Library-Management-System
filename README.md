...
<img width="1200" height="627" alt="image" src="https://github.com/user-attachments/assets/63b47fba-7823-4f13-8b20-14942437a4e7" />
...
3. **Run the Queries**: Use the SQL queries in the `task_1_to_12.sql` file to perform beginner level analysis and `task_13_to_18.sql` file for some advanced level analysis.
